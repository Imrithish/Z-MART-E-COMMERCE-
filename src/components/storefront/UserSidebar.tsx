    ...
    <div className="flex flex-col h-full bg-slate-900 text-white">
      <div className="p-8 flex items-center justify-between border-b border-white/5">
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            <span className="text-xl font-black tracking-tighter leading-none uppercase">Account</span>
            <span className="text-[8px] font-black uppercase tracking-[0.3em] text-slate-500">Member Portal</span>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 space-y-4 border-t border-white/5">
        ...
        >
          ...
          <span className="text-[11px] font-black uppercase tracking-widest">Return to Store</span>
        </Link>
        <button 
    ...
    <>
        ...
        <Sheet>
          ...
          <SheetContent side="left" className="p-0 border-none bg-slate-900 text-white w-80">
            <SheetHeader className="p-6 border-b border-white/5 bg-slate-950">
              <SheetTitle className="sr-only text-white">Account Menu</SheetTitle>
              <div className="flex items-center gap-2">
                <User className="h-6 w-6 text-primary" />
                <span className="text-xl font-black uppercase tracking-tighter">Member Menu</span>
              </div>
            </SheetHeader>
            <SidebarContent />
          </SheetContent>
      ...
      <aside className={cn(
        ...
        <div className="p-6 space-y-4 border-t border-white/5">
          ...
          >
            <Store className="h-6 w-6 shrink-0 transition-transform group-hover:scale-110" />
            {!isCollapsed && <span className="text-[11px] font-black uppercase tracking-widest">Return to Store</span>}
          </Link>
          <button 
            onClick={handleLogout}
            className="w-full flex items-center gap-4 px-6 py-4 rounded-2xl hover:bg-red-500/10 transition-all text-red-500/60 hover:text-red-500 group"
