        ...
        {!isCollapsed && (
          <div className="flex items-center gap-2 overflow-hidden">
            ...
            <div className="flex flex-col">
              <span className="text-lg md:text-xl font-black tracking-tighter leading-none">Z-MART</span>
              <span className="text-[7px] md:text-[8px] font-black uppercase tracking-[0.3em] text-slate-500">Admin</span>
            </div>
          </div>
        )}
        <Button 
