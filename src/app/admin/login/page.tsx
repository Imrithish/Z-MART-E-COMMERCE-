    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 font-body">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-2">
          <Link href="/" className="inline-flex items-center gap-2 text-primary font-black text-2xl tracking-tighter hover:scale-105 transition-transform">
        ...
        <Card className="shadow-2xl border-none rounded-[2.5rem] overflow-hidden bg-white">
          <CardHeader className="space-y-4 text-center pb-8 pt-10 px-8">
            ...
            <div className="space-y-1">
              ...
              <CardDescription className="text-slate-500 font-medium">Manage your marketplace operations</CardDescription>
            </div>
          </CardHeader>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  required 
                  className="bg-slate-50 border-slate-200 h-14 rounded-2xl px-6 font-bold focus:ring-primary/20 transition-all"
                  value={email}
              ...
              <Button type="submit" className="w-full h-16 bg-slate-900 hover:bg-primary text-white font-black uppercase tracking-widest rounded-2xl shadow-xl active:scale-95 transition-all text-xs group" disabled={isLoading}>
        ...
        <div className="bg-primary/5 border border-primary/10 p-6 rounded-3xl flex gap-4 backdrop-blur-sm">
          <div className="bg-white h-10 w-10 rounded-xl flex items-center justify-center shadow-sm shrink-0">
            <Info className="h-5 w-5 text-primary" />
          </div>
          <div className="space-y-1">
            <p className="text-[10px] font-black text-primary uppercase tracking-widest">Security Notice</p>
            <p className="text-xs font-medium text-slate-600 leading-relaxed">This terminal is restricted to registered merchants. All access attempts are logged for security purposes.</p>
          </div>
        </div>
      </div>
    </div>
